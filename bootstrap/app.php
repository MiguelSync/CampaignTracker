    ...
    ->withRouting(
        ...
        then: function () {
            Route::middleware('web')->group(function () {
                ...
                Route::group([], base_path('routes/web/profile.php'));
                Route::group([], base_path('routes/web/campaign.php'));
                Route::group([], base_path('routes/web/campaign_user.php'));
                Route::group([], base_path('routes/web/game.php'));
                Route::group([], base_path('routes/web/connection.php'));
                Route::group([], base_path('routes/web/user_connection.php'));
            });
